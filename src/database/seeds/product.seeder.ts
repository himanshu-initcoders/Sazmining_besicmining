      ...
      const products: Partial<Product>[] = [
        {
          ...
          description:
            'High-performance Bitcoin mining ASIC with 110 TH/s hashrate and 3250W power consumption.',
          imageUrl:
            'https://backend.basicmining.com/api/getFileAccess/product_image-wq8w8op-1741203430544.png',
          askPrice: 2499.99,
          hashRate: 110,
          power: 3250,
          efficiency: 29.5,
        ...
        },
        {
          ...
          description:
            'Bitcoin miner with 112 TH/s hashrate and 3472W power consumption.',
          imageUrl:
            'https://backend.basicmining.com/api/getFileAccess/product_image-wq8w8op-1741203430544.png',
          askPrice: 2399.99,
          hashRate: 112,
        ...
        },
        {
          ...
          description:
            'Bitcoin mining hardware with 90 TH/s hashrate and 3420W power consumption.',
          imageUrl:
            'https://backend.basicmining.com/api/getFileAccess/product_image-wq8w8op-1741203430544.png',
          askPrice: 1899.99,
          hashRate: 90,
        ...
        },
        {
          ...
          description:
            'Ethereum miner with 2000 MH/s hashrate and 2500W power consumption.',
          imageUrl:
            'https://backend.basicmining.com/api/getFileAccess/product_image-wq8w8op-1741203430544.png',
          askPrice: 3499.99,
          hashRate: 2000,
        ...
        },
        {
          ...
          description:
            'Scrypt miner for Litecoin and Dogecoin with 9.5 GH/s hashrate and 3425W power consumption.',
          imageUrl:
            'https://backend.basicmining.com/api/getFileAccess/product_image-wq8w8op-1741203430544.png',
          askPrice: 3999.99,
          hashRate: 9500,
