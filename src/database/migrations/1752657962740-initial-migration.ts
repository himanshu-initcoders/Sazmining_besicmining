...
export class InitialMigration1752657962740 implements MigrationInterface {
    name = 'InitialMigration1752657962740'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "auctions" ("id" SERIAL NOT NULL, "productId" integer NOT NULL, "bidderId" integer, "publisherId" integer NOT NULL, "startingPrice" double precision NOT NULL, "startDate" TIMESTAMP NOT NULL, "endDate" TIMESTAMP NOT NULL, "auctionStatus" "public"."auctions_auctionstatus_enum" NOT NULL DEFAULT 'Pending', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_87d2b34d4829f0519a5c5570368" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "products" ("id" SERIAL NOT NULL, "sku" character varying, "serialNumber" character varying NOT NULL, "modelName" character varying NOT NULL, "description" character varying NOT NULL, "imageUrl" character varying, "isActive" boolean NOT NULL DEFAULT true, "hashRate" double precision NOT NULL, "power" double precision NOT NULL, "efficiency" double precision NOT NULL, "disableBuyNow" boolean NOT NULL DEFAULT false, "type" "public"."products_type_enum" NOT NULL DEFAULT 'marketplace', "cooling" "public"."products_cooling_enum" NOT NULL DEFAULT 'air', "manufacturer" character varying NOT NULL, "productStatus" "public"."products_productstatus_enum" NOT NULL DEFAULT 'Online', "status" "public"."products_status_enum" NOT NULL DEFAULT 'Draft', "availability" "public"."products_availability_enum" NOT NULL DEFAULT 'In Stock', "askPrice" double precision NOT NULL, "contractId" character varying, "shippingPrice" double precision, "hosting" boolean NOT NULL DEFAULT false, "stockType" "public"."products_stocktype_enum" NOT NULL DEFAULT 'limited', "quantity" integer NOT NULL DEFAULT '0', "userId" integer, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_0806c755e0aca124e67c0cf6d7d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "email" character varying NOT NULL, "role" "public"."users_role_enum" NOT NULL DEFAULT 'user', "termsAgreed" boolean NOT NULL DEFAULT false, "username" character varying, "name" character varying, "phone" character varying, "profileCompletion" integer NOT NULL DEFAULT '0', "deviceToken" character varying, "profilePhoto" character varying, "password" character varying NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "contracts" ("id" SERIAL NOT NULL, "contractId" character varying NOT NULL, "location" character varying NOT NULL, "depositPrice" double precision NOT NULL, "setupPrice" double precision NOT NULL, "hostRate" double precision NOT NULL, "salesTaxPercent" double precision NOT NULL, "autoMaintenance" boolean NOT NULL DEFAULT false, "buyerId" integer NOT NULL, "productId" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_2c7b8f3a7b1acdd49497d83d0fb" PRIMARY KEY ("id"))`);
